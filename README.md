...
- crie um diretório no seu Drive e envie as imagens que gostaria de extrair as legendas. Certifique-se que estará na raíz do Drive;
...
*Há alguns tutoriais em vídeo ensinando a configurar a parte do Vision API e do Drive API.*


## Observações

- A Escala 3 foi uma escala de testes, apesar de estar funcional contanto que utilize a aplicação [FUSE filesystem over Google Drive](https://github.com/astrada/google-drive-ocamlfuse)  ou crie sua própria aplicação para obter as imagens localmente.;
- É aconselhado utilizar a aplicação toda a partir da Escala 4, se quiser obter a funcionalidade que envolva imagens.
...
- a partir da observação acima, você pode ser livre para substituir as implementações como o Vision API e Drive API, bem qualquer outra implementação parte da lógica do processo desta aplicação;
...
- O projeto tem o caráter de aprendizado e aperfeiçoamento.# Auto Flashcards
